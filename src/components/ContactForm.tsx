...
export const ContactForm = () => {
	...
	return (
		...
		>
			...
			<button
				type="submit"
				className="block mx-auto py-4 w-64 max-w-1/2 rounded-full bg-slate-200 text-sm text-gray-500 text-center tracking-widest shadow-md transition-all ease-easeInOutBack duration-300 hover:shadow-xl hover:tracking-[.25em]"
			>
				内容を確認の上、送信する
			</button>
		</form>
