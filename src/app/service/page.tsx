      ...
      <section className="section">
        ...
        <div>
          <dl className="grid grid-cols-4 gap-2 sm:gap-4 py-8 border-b border-gray-300">
            ...
            <dd className="col-span-2 sm:col-span-1 text-right">100,000円〜</dd>
          </dl>
          <dl className="grid grid-cols-4 gap-2 sm:gap-4 py-8 border-b border-gray-300">
            <dt className="col-span-2 sm:col-span-3 font-normal">
              コーポレートサイト
          ...
          <dl className="grid grid-cols-4 gap-2 sm:gap-4 py-8 border-b border-gray-300">
            ...
            <dd className="col-span-2 sm:col-span-1 text-right">200,000円〜</dd>
          </dl>
          <dl className="grid grid-cols-4 gap-2 sm:gap-4 py-8 border-b border-gray-300">
            <dt className="col-span-2 sm:col-span-3 font-normal">
              ホームページの運用
      ...
      <section className="section">
        ...
        <div className="mb-8">
          ...
          <p className="leading-8">
            ...
            <br />
            お客様の状況によって、分割払いや特定のタイミングでのお支払いも対応可能ですのでご相談ください。
          </p>
        </div>
        <div className="mb-8">
